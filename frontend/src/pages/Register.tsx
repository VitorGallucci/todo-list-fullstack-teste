// src/pages/Register.tsx (Trecho atualizado)
...
export function Register() {
  ...
  const handleRegister = async (e: React.FormEvent) => {
    ...
    try {
      ...
      // 3. Salva a "Pulseira VIP" (Token) e os dados no navegador
  ...
  return (
    <div className="min-h-screen flex items-center justify-center bg-gray-50 p-4">
      <div className="bg-white p-8 rounded-2xl shadow-xl w-full max-w-md">
        ...
        {erro && (
          <div className="bg-red-50 text-red-600 p-3 rounded-lg flex items-center gap-2 mb-6 text-sm transition-all">
        ...
        {sucesso && (
          <div className="bg-green-50 text-green-700 p-3 rounded-lg flex items-center gap-2 mb-6 text-sm transition-all">
          ...
          <div>
            ...
            <div className="relative">
              ...
              <input
                ...
                required
                disabled={sucesso}
                className="w-full pl-10 pr-3 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-green-600 focus:border-transparent outline-none transition-all disabled:bg-gray-100 disabled:text-gray-500"
